...
* [Pre-requisites](toy-example.md#pre-requisites)
* [The Story](toy-example.md#the-story)
* [Video Tutorial](toy-example.md#video-tutorial)
* [Before You Begin](toy-example.md#before-you-begin)
* [Creating the Task](toy-example.md#creating-the-task)
* [Building the Workflow](toy-example.md#building-the-workflow)
  * [Step 1: Offboard Crew](toy-example.md#step-1-offboard-crew)
  * [Step 2: Unload Cargo](toy-example.md#step-2-unload-cargo)
  * [Step 3: Retire Ship](toy-example.md#step-3-retire-ship)
* [Instant Deployment and Testing](toy-example.md#instant-deployment-and-testing)
* [Bonus: Sending Notifications via Email](toy-example.md#bonus-sending-notifications-via-email)
* [What You Learned](toy-example.md#what-you-learned)
...
* The ship can only be retired _after_ both cargo and crew are offboarded
...
![Getting Started Screen](../../.gitbook/assets/getting-started-screen.png)
...
1. Go to the **Tasks** tab\
   ![Task Tab](../../.gitbook/assets/task-menu-selection.png)
2. Click `New Task`\
   ![New Task](../../.gitbook/assets/new-task.png)
...
![Enter Task](../../.gitbook/assets/enter-new-task.png)
...
![Step Start](../../.gitbook/assets/retire-ship-1.png)

2. Name the step `offboard crew`\
   ![Name Step](../../.gitbook/assets/name-new-step.png)
3. Click on `match invalid` ![matching-conditions-json](../../.gitbook/assets/blank-step.png)
...
![Match JSON](../../.gitbook/assets/matching-json.png)
...
![Code Step](../../.gitbook/assets/code-new-step.png)

6. Click **Save**, then press the lightning bolt icon\
   ![Relaunch Task](../../.gitbook/assets/relaunch-task.png)
7. Confirm execution:\
   ![Task Executed](../../.gitbook/assets/second-task-execution.png)
8.  Click **Change** to see the task data diff ![Code Shown](../../.gitbook/assets/show-changes.png)

    ![Data Changes](../../.gitbook/assets/data-changes.png)
...
4. Re-run using lightning bolt\
   ![Relaunch Task Again](../../.gitbook/assets/relaunch-task.png)
5. Result:\
   ![Task Executed with Cargo](../../.gitbook/assets/task-execution-2.png)
...
![Match Crew and Ship](../../.gitbook/assets/match-crew-and-ship.png)

7. As the condition is no longer matching with the task data, it shows `No Match`:\
   ![No Match](../../.gitbook/assets/step-no-match.png)
8. Re-run task and the crew has been offboarded first:\
   ![Execution Order Confirmed](../../.gitbook/assets/task-execution-3.png)
...
![Task Done](../../.gitbook/assets/task-done.png)
...
![email smtp connector](../../.gitbook/assets/email-smtp-connector.png)

3. Connect and authorize

![connect-email](../../.gitbook/assets/connect-email.png)
...
![email-in-step](../../.gitbook/assets/email-in-step.png)
...
[Next: Build your first real-time integration ›](../connectors/)
